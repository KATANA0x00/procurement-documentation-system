<template>
    <div>
        <Accordion groupName="ประเภทการคืนเงิน" color="#FF8800">
            <ul class="type-list">
                <li
                    v-for="item in type_enum"
                    @click="dataPayment.type = item.value"
                >
                    <div
                    ...
                    <input
                        v-if="
                            item.needInput && dataPayment.type == item.value
                        "
                        type="text"
                        placeholder="ระบุบุคคลที่ต้องคืนเงิน"
                        v-model="dataPayment.refund_person"
                    />
                </li>
            </ul>
        </Accordion>
        <Accordion groupName="ประเภทการคืนเงิน" color="#20D897">
            ...
            <div class="drag-header">
                ...
                <span style="text-align: left"
                    >ชื่อบริษัท ห้างหุ้นส่วน ร้านค้า</span
                >
                <span>เล่มที่</span>
                <span>เลขที่</span>
