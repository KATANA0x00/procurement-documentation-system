    ...
    { text: 'และพร้อมกันนี้ได้แนบเอกสารประกอบการพิจารณา ดังนี้' },
    {
      columns: [
        ...
        [
          ...
          (new Date(data.doc_date_p01 ?? data.created_date) < new Date('2026-01-19')) ? sign('ผู้ช่วยศาสตราจารย์ ดร.เปี่ยมภูมิ   สฤกพฤกษ์', 'รองคณบดี') : sign('ผู้ช่วยศาสตราจารย์ ดร.อนรรฆพล แสนทน', 'รองคณบดี'),
          { text: ' ' },
